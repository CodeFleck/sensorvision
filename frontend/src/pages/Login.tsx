      ...
      <div className="relative min-h-screen flex">
        ...
        <div className="hidden lg:flex lg:w-1/2 xl:w-3/5 flex-col justify-between p-12 xl:p-20">
          ...
          <div className="max-w-xl">
            ...
            <p className="text-lg text-white/85 leading-relaxed mb-12 max-w-md font-light">
            ...
            <div className="flex flex-wrap gap-3">
              {[
                ...
                >
                  ...
                  <span className="text-sm text-white/85 group-hover:text-white/95 transition-colors">{label}</span>
                </div>
              ))}
            </div>
          </div>
              ...
              >
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div className="flex justify-end">
                    <Link
                      to="/forgot-password"
                      className="text-sm text-white/80 hover:text-teal-400 transition-colors duration-200"
                    >
                      Forgot password?
                    </Link>
                  </div>
                ...
                <div className="relative my-8">
                  ...
                  <div className="relative flex justify-center">
                    <span className="px-4 text-sm text-white/70 bg-black">or continue with</span>
                  </div>
                </div>
