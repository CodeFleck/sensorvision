            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <button
                  ...
                  disabled={loading}
                  aria-busy={loading}
                  className="group w-full relative overflow-hidden px-6 py-4 rounded-xl font-semibold text-white transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-[#0969da]/25 hover:shadow-xl hover:shadow-[#0969da]/30"
                >
                  {/* Button gradient */}
