...
- generic [ref=e2]:
  ...
  - generic [ref=e16]:
    ...
    - generic [ref=e241]:
      ...
      - main [ref=e263]:
        - generic [ref=e265]:
          - strong [ref=e266]: "Error:"
          - text: Maximum 10 plugin operations per minute. Please try again later.
          - button "Retry" [ref=e267] [cursor=pointer]
      - contentinfo [ref=e268]:
        - generic [ref=e270]:
          - paragraph [ref=e272]: © 2025 SensorVision. All rights reserved.
          - button "Report Issue" [ref=e274] [cursor=pointer]:
            - img [ref=e275]
            - text: Report Issue
```