...
import io.indcloud.sdk.model.ClientConfig;
...
/**
 * Main client for sending telemetry data to Industrial Cloud platform.
 *
 * <p>Example usage:
 * <pre>{@code
 ...
 * @version 0.1.0
 */
public class IndCloudClient {
    private static final Logger logger = LoggerFactory.getLogger(IndCloudClient.class);
    ...
    private IndCloudClient(ClientConfig config) {
        this.config = config;
        ...
        try {
            ...
            try (Response response = httpClient.newCall(request).execute()) {
                ...
                switch (response.code()) {
                    ...
                    default:
                        throw new IndCloudException("Unexpected error: " + responseBody);
                }
            }
        } catch (IOException e) {
            if (attemptsLeft > 0) {
    ...
    /**
     * Builder for creating IndCloudClient instances.
     */
    public static class Builder {
        ...
        public IndCloudClient build() {
            ...
            return new IndCloudClient(config);
        }
    }
}
