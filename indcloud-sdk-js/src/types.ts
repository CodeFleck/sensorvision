/**
 * Type definitions for IndCloud SDK
 */

/**
 * Configuration options for IndCloud client
 */
export interface ClientConfig {
  /** Base URL of the IndCloud API */
  apiUrl: string;
...
/**
 * Telemetry data to be sent to IndCloud
 */
...
export interface WebSocketConfig {
  /** WebSocket URL of the IndCloud server */
  wsUrl: string;
  /** API key for authentication */
  apiKey: string;
