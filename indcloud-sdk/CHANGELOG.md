...
All notable changes to the IndCloud Python SDK will be documented in this file.
...
### Fixed
- **BREAKING**: Fixed exception inconsistency in validation functions. `validate_device_id()` and `validate_telemetry_data()` now raise `ValidationError` instead of `ValueError` to match the documented API contract in `IndCloudClient.send_data()`.
...
### Added
- Initial release of IndCloud Python SDK
- `IndCloudClient` for synchronous telemetry ingestion
...
- Published to PyPI: https://pypi.org/project/indcloud-sdk/
...
[0.1.1]: https://github.com/CodeFleck/indcloud/compare/v0.1.0...v0.1.1
[0.1.0]: https://github.com/CodeFleck/indcloud/releases/tag/v0.1.0
