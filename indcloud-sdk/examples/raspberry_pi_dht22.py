...
connected to a Raspberry Pi and send it to IndCloud.
...
Requirements:
    pip install indcloud-sdk Adafruit-DHT
...
API_URL = "http://localhost:8080"  # Change to your IndCloud URL
