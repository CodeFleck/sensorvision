"""
Unit tests for IndCloud synchronous client.
"""
import pytest
from unittest.mock import Mock, patch, MagicMock
from indcloud import IndCloudClient, IngestionResponse
...
def client():
    ...
    with patch('indcloud.client.requests'):
        return IndCloudClient(
