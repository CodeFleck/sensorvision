...
import io.indcloud.dto.IssueCommentDto;
import io.indcloud.dto.IssueCommentRequest;
...
import io.indcloud.service.IssueCommentService;
import io.indcloud.service.IssueSubmissionService;
...
import io.indcloud.model.IssueComment;
...
public class IssueSubmissionController {
    ...
    public ResponseEntity<IssueCommentDto> addComment(
        ...
        if (!io.indcloud.util.HtmlUtils.hasTextContent(request.message())) {
    ...
    public ResponseEntity<IssueCommentDto> addCommentWithAttachment(
        ...
        if (message == null || !io.indcloud.util.HtmlUtils.hasTextContent(message)) {
            throw new IllegalArgumentException("Message is required");
        }
