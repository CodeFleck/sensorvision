...
import io.indcloud.dto.RuleCreateRequest;
import io.indcloud.dto.RuleResponse;
import io.indcloud.service.RuleService;
...
public class RuleController {
    ...
    @PutMapping("/{id}")
    public RuleResponse updateRule(@PathVariable UUID id, @Valid @RequestBody RuleCreateRequest request) {
