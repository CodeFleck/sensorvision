...
import io.indcloud.dto.DeviceImportRequest;
import io.indcloud.dto.TelemetryImportRequest;
...
public class DataImportService {
    ...
    private io.indcloud.mqtt.TelemetryPayload convertToPayload(TelemetryImportRequest request) {
        ...
        return new io.indcloud.mqtt.TelemetryPayload(
            request.getDeviceId(),
            timestamp,
            variables,
            Map.of()
