...
import io.indcloud.repository.IssueCommentRepository;
...
public class IssueCommentService {
    ...
    public IssueCommentDto addUserComment(Long issueId, IssueCommentRequest request, MultipartFile attachment) {
        ...
        if (!io.indcloud.util.HtmlUtils.hasTextContent(sanitizedMessage)) {
            throw new io.indcloud.exception.BadRequestException(
