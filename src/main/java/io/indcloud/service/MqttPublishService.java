...
public class MqttPublishService {
     ...
     * Topic: indcloud/devices/{deviceId}/commands
     *
    ...
    public void publishCommand(String deviceId, String command, Object payload) {
        try {
            String topic = String.format("indcloud/devices/%s/commands", deviceId);
     ...
     * Topic: indcloud/devices/broadcast/commands
     */
    public void broadcastCommand(String command, Object payload) {
        try {
            String topic = "indcloud/devices/broadcast/commands";
