...
class StatisticalFunctionsTest {
    ...
    void testStddev_WithMultipleValues() {
        ...
        // Expected stddev should be around 4.899 (sqrt of 24)
        assertTrue(result.doubleValue() > 4.8 && result.doubleValue() < 5.0,
            "Expected stddev around 4.9 but got " + result);
    }
    ...
    void testRate_WithIncreasingValues() {
        ...
        assertTrue(result.compareTo(new BigDecimal("40")) == 0, "Expected 40 but got " + result);
    }
    ...
    void testPercentChange_WithIncrease() {
        ...
        // (150 - 100) / 100 * 100 = 50%
        assertTrue(result.compareTo(new BigDecimal("50")) == 0, "Expected 50 but got " + result);
    }
