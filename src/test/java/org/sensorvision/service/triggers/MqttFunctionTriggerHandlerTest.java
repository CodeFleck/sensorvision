package org.sensorvision.service.triggers;
...
class MqttFunctionTriggerHandlerTest {
    ...
    void testMatchesTrigger_SimpleTopicPattern() {
        // Given
        FunctionTrigger trigger = createTrigger("{\"topicPattern\": \"sensorvision/devices/+/telemetry\"}");

        ObjectNode event = objectMapper.createObjectNode();
        TriggerContext context = TriggerContext.builder()
            .eventSource("sensorvision/devices/sensor-001/telemetry")
            .build();
    ...
    void testMatchesTrigger_WildcardTopicPattern() {
        // Given
        FunctionTrigger trigger = createTrigger("{\"topicPattern\": \"sensorvision/#\"}");

        ObjectNode event = objectMapper.createObjectNode();
        TriggerContext context = TriggerContext.builder()
            .eventSource("sensorvision/devices/sensor-001/telemetry/voltage")
            .build();
    ...
    void testBuildEventPayload() {
        ...
        assertThat(payload.get("topic").asText()).isEqualTo("sensorvision/devices/sensor-001/telemetry");
